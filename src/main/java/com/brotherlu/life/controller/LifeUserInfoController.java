...
//    }
    ...
    @PostMapping("/detail/{user_no}")
    public Result detail(@PathVariable(name="user_no",required=true) Integer user_no) {
        LifeUserInfo lifeUserInfo = lifeUserInfoService.findById(user_no);
